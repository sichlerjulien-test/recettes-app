...
CREATE FUNCTION public.update_sejour_with_participants(p_id uuid, p_nom text, p_date_debut date, p_nb_jours integer, p_repartition_repas jsonb, p_parametres jsonb, p_participants jsonb) RETURNS void
